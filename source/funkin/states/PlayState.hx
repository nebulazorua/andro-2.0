...
import funkin.data.Highscore; // maybe this should be moved into dependencies, with how many things use it
...
class PlayState extends MusicBeatState
{
	...
	private function popUpScore(strumtime:Float):Void
	{
		...
		// TODO: rewrite this to be independent of the safezone offset
		// actually I just wanna rewrite popupscore entirely tbh
